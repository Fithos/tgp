package ch.usi.dag.tgp.task.bc;
...
/**
 * <h1>Instrumentation (Bytecode count)</h1>
 * This class contains instrumentation code to be inserted in the target application. 
 * The code profiles task granularity, representing it in terms of bytecode count.
 * <p>
...
public class Instrumentation {  
	...
	public static void beforeBasicBlockEntrance(final BasicBlockStaticContext bbsc) {
		bc += bbsc.getSize();		
	}		
	...
	public static void afterExecutionMethod(DynamicContext dc, MethodStaticContext msc) {
		...
		final long c_current = bc - c_entry_sl - c_nested_task;
